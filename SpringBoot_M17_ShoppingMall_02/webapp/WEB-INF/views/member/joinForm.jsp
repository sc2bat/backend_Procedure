...
<form method="post" name="joinForm" id="join" action="join">
	<fieldset>
		...
		<label>User ID</label>
		<input type="text" name="userid" value="${dto.userid }" size="12">
	...
	<fieldset>
	    ...
	    <input type="text" name="zip_num"   size="10"  value="${dto.zip_num }"  >      
	    <input type="button" value="주소 찾기" class="dup" onclick="post_zip()"><br>
	    
		<label>Address</label>
		<input type="text" name="address" value="${dto.address }"  size="50"><br>
		<label>&nbsp;</label>
		<input type="text" name="address2" value="${dto.address2 }"  size="25"> <br>
